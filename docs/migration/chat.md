...
- **`SMSG_CHAT_PLAYER_AMBIGUOUS`, `SMSG_DEFENSE_MESSAGE`** — ambiguous player wire layout exists but is never sent; defense message wire/send path remains absent.
