...
- Latest completed slice: `#NEXT.R8.ENTITIES.418 — Map::UnloadGrid applies GUID actions and purges personal phases` (review `APROBADO`; validation OK; committed locally at `current #418 HEAD`; no push/install/restart).
...
Overall core migration estimate after #418 Map::UnloadGrid GUID-action/personal-phase seam: `~90.8%` (was `~90.7%` after #417; do not claim >95% until ownership/runtime gaps below are substantially closed).
