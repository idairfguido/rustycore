...
- Latest completed committed slice in this handoff: `#NEXT.R8.ENTITIES.402 — Map-local GUID sequence seam for loaded-grid Creature/GameObject LoadFromDB/DoRespawn` (review `APROBADO`; focused checks passed; committed locally in the current #402 HEAD).
...
- No push/install/restart performed for #383, #384, #385, #386, #387, #388, #389, #390, #391, #392, #393, #394, #395, #396, #397, #398, #399, #400, #401, or #402.
