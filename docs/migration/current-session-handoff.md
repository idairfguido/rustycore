...
- Latest completed slice: `#NEXT.R8.ENTITIES.415 — Player logout cleanup removes canonical map Player before ObjectAccessor` (review `APROBADO`; validation OK; committed locally at `current #415 HEAD`; no push/install/restart).
...
Overall core migration estimate after #413 ObjectAccessor typed Player HashMapHolder seam: `~90.1%` (was `~89.9%` after #411; do not claim >95% until ownership/runtime gaps below are substantially closed).
