...
- Latest completed slice: `#NEXT.R8.ENTITIES.419 — Map deferred remove-list physical removal seam` (review `APROBADO`; validation OK; committed locally at `current #419 HEAD`; no push/install/restart).
