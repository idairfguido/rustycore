...
- Latest completed slice: `#NEXT.R8.ENTITIES.420 — Map-owned switch-list drain for temporary Unit world-object container toggles` (review `APROBADO`; validation OK; committed locally at `current #420 HEAD`; no push/install/restart).
...
- No push/install/restart performed for #383, #384, #385, #386, #387, #388, #389, #390, #391, #392, #393, #394, #395, #396, #397, #398, #399, #400, #401, #402, #403, #404, #405, #406, #407, #408, #409, #410, #411, #412, or #413.
...
Overall core migration estimate after #420 map-owned switch-list queue + drain seam: `~91.0%` (was `~90.9%` after #419; do not claim >95% until ownership/runtime gaps below are substantially closed).
...
Manual test point: no new client-facing manual milestone from #410/#420. Fixed-level and variable-level supported DB-backed Creature records plus supported intrinsic GameObject records can flow through the live loaded-grid respawn seam into `MapObjectRecord`/AddToMap with map-owned GUID generation. This now represents DB-backed GameObject linked-trap pre-add, map-local removal, deferred remove-list drain, and temporary Unit switch-list container movement only. It still does not support creature vehicle templates, full AddToWorld/ObjectAccessor/fanout/scripts/AI/zonescript/formation/dynamic-tree side effects, full GameObject runtime, model/collision, visibility distance overrides, full transport runtime, ObjectGridLoader rewrite, PoolMgr full live spawn work, AreaTrigger runtime, GO_JUST_DEACTIVATED runtime, full CleanupsBeforeDelete, dynamic tree/session fanout, install, restart, or push.
