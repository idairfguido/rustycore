...
- `crates/wow-database/src/statements/character.rs` — 2354 lines — `CharStatements` enum (172 named variants + generated C++ SQL parity harness — partial as a named registry)
