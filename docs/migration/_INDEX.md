...
| L1 | shared/Realm | `src/server/shared/Realm/` | [shared-realm.md](shared-realm.md) | ⚠️ (~74%; BNet RealmHandle/cfg swap, normalized names, build-version lookup, `JamJSONRealmEntry` and strong RealmHandle fixed; storage/golden/e2e pending) | ⚠️ |
