...
- Inventarios base contra C++: [inventory/cpp-server-tree.md](inventory/cpp-server-tree.md), [inventory/cpp-files-by-module.md](inventory/cpp-files-by-module.md) y [inventory/cpp-handlers-opcodes.md](inventory/cpp-handlers-opcodes.md).
