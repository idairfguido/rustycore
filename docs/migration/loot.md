...
- Represented chest loot opening exists for `CMSG_GAME_OBJ_USE`; mining/herb nodes, fishing bobbers and full `GameObject::Use` side effects remain pending.
