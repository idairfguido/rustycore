...
- [ ] **#026d** `wow-packet`: serializers VALUES con arrays/nested para `CorpseData`, `GameObjectData` y `AreaTriggerData`; partir más si el contraste de nested masks lo exige.
