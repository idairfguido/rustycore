...
- [ ] **#026i** `wow-packet`: serializer VALUES completo para `UF::ActivePlayerData::WriteUpdate`, incluyendo máscaras de 48 bloques, `SkillInfo`, inventario/buyback, dinámicos de quests/titles/toys/transmog/traits, research y PVP info. Parcial cerrado en `#026i1`; siguen pendientes el writer genérico completo y arrays/dinámicos no usados por el runtime común.
