...
- [ ] **#026i** `wow-packet`: serializer VALUES completo para `UF::ActivePlayerData::WriteUpdate`, incluyendo máscaras de 48 bloques, `SkillInfo`, inventario/buyback, dinámicos de quests/titles/toys/transmog/traits, research y PVP info. Parciales cerrados en `#026i1` y `#026i2`; siguen pendientes el writer genérico completo y arrays/dinámicos no usados por el runtime común.
