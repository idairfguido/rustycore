    ...
    fn sql(self) -> &'static str {
        match self {
            ...
            Self::SEL_CREATURES_IN_RANGE => concat!(
                ...
                "COALESCE(cmo.Ground, ctmv.Ground, 1), COALESCE(cmo.Swim, ctmv.Swim, 1), COALESCE(cmo.Flight, ctmv.Flight, 0), COALESCE(cmo.Random, ctmv.Random, 0), ",
                "c.wander_distance, ",
            ...
            Self::SEL_CREATURE_SPAWNS => concat!(
                ...
                "COALESCE(cmo.Ground, ctm.Ground, 1), COALESCE(cmo.Swim, ctm.Swim, 1), COALESCE(cmo.Flight, ctm.Flight, 0), COALESCE(cmo.Random, ctm.Random, 0) ",
                "FROM creature ",
...
mod tests {
    ...
    fn player_choice_statements_match_cpp_sql_exactly() {
        ...
        let reward_currencies_sql =
            WorldStatements::SEL_PLAYER_CHOICE_RESPONSE_REWARD_CURRENCIES.sql();
