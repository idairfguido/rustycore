...
pub use spell::{
    ...
    SPELL_ATTR0_CU_SHARE_DAMAGE_LIKE_CPP, SPELL_AURA_DUMMY_LIKE_CPP, SpellAreaLikeCpp,
    SpellAreaLoadErrorKindLikeCpp, SpellAreaLoadErrorLikeCpp, SpellAreaLoadOutcomeLikeCpp,
    SpellAreaRowLikeCpp, SpellAreaStoreLikeCpp, SpellChainNodeLikeCpp, SpellChainStoreLikeCpp,
