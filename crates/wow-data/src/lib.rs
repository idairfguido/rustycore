...
pub use spell::{
    SPELL_AURA_DUMMY_LIKE_CPP, SpellEffectInfo, SpellInfo, SpellLearnSourceSpellInfoLikeCpp,
    SpellLearnSpellEffectLikeCpp, SpellLearnSpellLoadErrorKindLikeCpp,
    SpellLearnSpellLoadErrorLikeCpp, SpellLearnSpellLoadOutcomeLikeCpp,
    SpellLearnSpellLoadWarningKindLikeCpp, SpellLearnSpellLoadWarningLikeCpp,
    SpellLearnSpellNodeLikeCpp, SpellLearnSpellSqlRowLikeCpp, SpellLearnSpellStoreLikeCpp,
    SpellLinkedLoadErrorKindLikeCpp, SpellLinkedLoadErrorLikeCpp, SpellLinkedLoadOutcomeLikeCpp,
    SpellLinkedLoadWarningKindLikeCpp, SpellLinkedLoadWarningLikeCpp, SpellLinkedRowLikeCpp,
    SpellLinkedSpellInfoLikeCpp, SpellLinkedStoreLikeCpp, SpellLinkedTypeLikeCpp,
    SpellPetAuraLoadErrorKindLikeCpp, SpellPetAuraLoadErrorLikeCpp, SpellPetAuraLoadOutcomeLikeCpp,
    SpellPetAuraRowLikeCpp, SpellPetAuraSourceEffectLikeCpp, SpellPetAuraSourceLookupLikeCpp,
    SpellPetAuraStoreLikeCpp, SpellRequiredLoadErrorKindLikeCpp, SpellRequiredLoadErrorLikeCpp,
