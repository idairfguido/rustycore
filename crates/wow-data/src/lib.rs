...
pub use area_trigger::{
    ...
    AreaTriggerTeleport, QuestAreaTriggerLoadOutcomeLikeCpp, QuestAreaTriggerLoadReportLikeCpp,
    QuestAreaTriggerRowLikeCpp, QuestAreaTriggerStoreLikeCpp, TavernAreaTriggerLoadOutcomeLikeCpp,
    TavernAreaTriggerLoadReportLikeCpp, TavernAreaTriggerStoreLikeCpp, TriggerShape,
    load_area_triggers,
};
...
pub use battlemaster_list::{
    ...
    BATTLEGROUND_SA_LIKE_CPP, BATTLEGROUND_TP_LIKE_CPP, BATTLEGROUND_TYPE_NONE_LIKE_CPP,
    BATTLEGROUND_WS_LIKE_CPP, BATTLEMASTER_LIST_FLAG_INTERNAL_ONLY_LIKE_CPP, BattlemasterListEntry,
    BattlemasterListStore, HOLIDAY_CALL_TO_ARMS_AB_LIKE_CPP, HOLIDAY_CALL_TO_ARMS_AV_LIKE_CPP,
    HOLIDAY_CALL_TO_ARMS_BG_LIKE_CPP, HOLIDAY_CALL_TO_ARMS_ES_LIKE_CPP,
    HOLIDAY_CALL_TO_ARMS_IC_LIKE_CPP, HOLIDAY_CALL_TO_ARMS_SA_LIKE_CPP,
    HOLIDAY_CALL_TO_ARMS_TP_LIKE_CPP, HOLIDAY_CALL_TO_ARMS_WG_LIKE_CPP, HOLIDAY_NONE_LIKE_CPP,
    HolidayWorldStateLookupLikeCpp, MAP_ARENA_LIKE_CPP, MAP_BATTLEGROUND_LIKE_CPP,
...
pub use spell::{
    GENDER_FEMALE_LIKE_CPP, GENDER_MALE_LIKE_CPP, GENDER_NONE_LIKE_CPP,
    ImplicitSpellProcEffectLikeCpp, ImplicitSpellProcSourceLikeCpp, MAX_SPELL_EFFECTS_LIKE_CPP,
    ...
    SPELL_ATTR0_CU_IS_TALENT_LIKE_CPP, SPELL_ATTR0_CU_NO_INITIAL_THREAT_LIKE_CPP,
    SPELL_ATTR0_CU_SHARE_DAMAGE_LIKE_CPP, SPELL_AURA_DUMMY_LIKE_CPP,
    ServersideSpellEffectKeyLikeCpp, ServersideSpellEffectLikeCpp,
    ServersideSpellEffectLoadErrorKindLikeCpp, ServersideSpellEffectLoadErrorLikeCpp,
    ServersideSpellEffectLoadOutcomeLikeCpp, ServersideSpellEffectLoadWarningKindLikeCpp,
    ServersideSpellEffectLoadWarningLikeCpp, ServersideSpellEffectRowLikeCpp,
    ServersideSpellEffectStoreLikeCpp, ServersideSpellInfoLikeCpp,
    ...
    SpellLearnSpellLoadWarningLikeCpp, SpellLearnSpellNodeLikeCpp, SpellLearnSpellSqlRowLikeCpp,
    SpellLearnSpellStoreLikeCpp, SpellLinkedLoadErrorKindLikeCpp, SpellLinkedLoadErrorLikeCpp,
    SpellLinkedLoadOutcomeLikeCpp, SpellLinkedLoadWarningKindLikeCpp,
    ...
    SpellProcEntryLikeCpp, SpellProcKeyLikeCpp, SpellProcLoadErrorKindLikeCpp,
    SpellProcLoadErrorLikeCpp, SpellProcLoadOutcomeLikeCpp, SpellProcRowLikeCpp,
    SpellProcSourceSpellInfoLikeCpp, SpellProcStoreLikeCpp, SpellRankEdgeLikeCpp,
