...
pub use pet::{
    ...
    PetAddToWorldOutcomeLikeCpp, PetAliveOwnerUpdateOutcome, PetAuraSaveEffectLikeCpp,
    PetAuraSaveOperationLikeCpp, PetAuraSaveRefLikeCpp, PetCorpseUpdateOutcome,
    PetDeathStateUpdateOutcome, PetDeclinedNamesLikeCpp, PetDeleteFromDbOperationLikeCpp,
    PetDurationUpdateOutcome, PetGroupUpdateOutcomeLikeCpp, PetLevelUpdateOutcome,
    PetLoadInfoResult, PetLoadSelection, PetRemoveFromWorldOutcomeLikeCpp, PetRemovePlanLikeCpp,
    PetSaveMode, PetSaveToDbOperationLikeCpp, PetSaveToDbPlan, PetSaveToDbSkipReason,
    PetSetDisplayIdOutcomeLikeCpp, PetSpell, PetSpellSaveOperationLikeCpp, PetSpellState,
    PetSpellType, PetStable, PetStableInfo, PetType, PetXpUpdateOutcome,
};
pub use player::{
