...
pub use game_object::{
    ...
    GAME_OBJECT_DATA_CREATED_BY_BIT, GAME_OBJECT_DATA_CUSTOM_PARAM_BIT,
    GAME_OBJECT_DATA_DISPLAY_ID_BIT, GAME_OBJECT_DATA_FACTION_TEMPLATE_BIT,
    GAME_OBJECT_DATA_FLAGS_BIT, GAME_OBJECT_DATA_LEVEL_BIT, GAME_OBJECT_DATA_PARENT_BIT,
    GAME_OBJECT_DATA_PERCENT_HEALTH_BIT, GAME_OBJECT_DATA_STATE_BIT, GAME_OBJECT_DATA_TYPE_ID_BIT,
    GAMEOBJECT_DATA_CHEST_DUNGEON_ENCOUNTER, GAMEOBJECT_DATA_CHEST_LINKED_TRAP,
    GAMEOBJECT_DATA_CHEST_LOOT, GAMEOBJECT_DATA_CHEST_PERSONAL_LOOT,
    GAMEOBJECT_DATA_CHEST_PUSH_LOOT, GAMEOBJECT_DATA_CHEST_TRIGGERED_EVENT,
    GAMEOBJECT_DATA_CHEST_USE_GROUP_LOOT_RULES, GAMEOBJECT_DATA_GATHERING_NODE_DESPAWN_DELAY,
    GAMEOBJECT_DATA_GATHERING_NODE_LINKED_TRAP, GAMEOBJECT_DATA_GATHERING_NODE_MAX_LOOTS,
    GAMEOBJECT_DATA_GATHERING_NODE_SPELL, GAMEOBJECT_DATA_GATHERING_NODE_TRIGGERED_EVENT,
    GAMEOBJECT_DATA_GATHERING_NODE_XP_DIFFICULTY, GAMEOBJECT_LOOT_MODE_DEFAULT,
    GAMEOBJECT_TYPE_AREADAMAGE, GAMEOBJECT_TYPE_BARBER_CHAIR, GAMEOBJECT_TYPE_BINDER,
    GAMEOBJECT_TYPE_CAMERA, GAMEOBJECT_TYPE_CHAIR, GAMEOBJECT_TYPE_CHEST,
...
pub use unit::{
    ...
    SPELL_AURA_MOD_UNATTACKABLE_LIKE_CPP, UNIT_DATA_BOUNDING_RADIUS_BIT, UNIT_DATA_CLASS_ID_BIT,
    ...
    UNIT_DATA_POWER_FIRST_BIT, UNIT_DATA_POWER_PARENT_BIT, UNIT_DATA_RACE_BIT, UNIT_DATA_SEX_BIT,
    UNIT_DATA_STAND_STATE_BIT, UNIT_DATA_TARGET_BIT, UNIT_DATA_VIRTUAL_ITEMS_FIRST_BIT,
    UNIT_DATA_VIRTUAL_ITEMS_PARENT_BIT, Unit, UnitAttackContextLikeCpp, UnitAttackStartOutcome,
    UnitAttackStopOutcome, UnitDataUpdate, UnitDataValues, UnitValuesUpdate,
};
pub use unit_subsystems::{
    ...
    CharmInfoState, CharmType, CombatReferenceState, CombatSubsystem, ControlSubsystem,
    CurrentSpellRef, CurrentSpellSlot, DIMINISHING_AOE_KNOCKBACK, DIMINISHING_DISORIENT,
    DIMINISHING_INCAPACITATE, DIMINISHING_LIMITONLY, DIMINISHING_MAX, DIMINISHING_NONE,
    DIMINISHING_RESET_INTERVAL_MS, DIMINISHING_ROOT, DIMINISHING_SILENCE, DIMINISHING_STUN,
    DIMINISHING_TAUNT, DiminishingLevel, DiminishingReturnState, DistractMovementAction,
    DistractMovementFinalize, EVENT_ASSIST_MOVE, EVENT_CHARGE, EVENT_CHARGE_PREPATH, EVENT_JUMP,
    GenericMovementInform, INFINITY_COOLDOWN_DELAY_MS, IdleMovementAction, MAX_SPELL_CHARM,
    MAX_SPELL_SCHOOL, MAX_SUMMON_SLOT, MAX_TOTEM_SLOT as MAX_UNIT_TOTEM_SLOT,
    MAX_UNIT_ACTION_BAR_INDEX, MOTIONMASTER_FLAG_DELAYED, MOTIONMASTER_FLAG_INITIALIZATION_PENDING,
    ...
    MotionMasterDelayedAction, MotionMasterDelayedActionPayload, MotionMasterDelayedActionType,
    ...
    ThreatReferenceState, ThreatTauntState, UnitSubsystems, VehicleKitState, VehicleSubsystem,
};
