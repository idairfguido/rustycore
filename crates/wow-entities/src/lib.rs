...
pub use pet::{
    ...
    PetCorpseUpdateOutcome, PetDeclinedNamesLikeCpp, PetDurationUpdateOutcome, PetLoadInfoResult,
    PetLoadSelection, PetSaveMode, PetSpell, PetSpellState, PetSpellType, PetStable, PetStableInfo,
    PetType,
};
pub use player::{
