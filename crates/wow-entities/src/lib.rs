...
pub use creature::{
    ...
    CreatureAddToWorldVehicleResetContextLikeCpp, CreatureAddonLifecycleRecordLikeCpp,
    CreatureAiOwnershipState, CreatureAiState, CreatureAimInitializeOutcomeLikeCpp,
...
pub use game_object::{
    ...
    GAMEOBJECT_DATA_UI_LINK_SPELL_FOCUS_TYPE, GAMEOBJECT_LOOT_MODE_DEFAULT,
    GAMEOBJECT_TYPE_AREADAMAGE, GAMEOBJECT_TYPE_BARBER_CHAIR, GAMEOBJECT_TYPE_BINDER,
    GAMEOBJECT_TYPE_BUTTON, GAMEOBJECT_TYPE_CAMERA, GAMEOBJECT_TYPE_CAPTURE_POINT,
    ...
    GAMEOBJECT_TYPE_TRAP, GAMEOBJECT_TYPE_UI_LINK, GO_DYNFLAG_LO_ACTIVATE, GO_DYNFLAG_LO_DEPLETED,
    GO_DYNFLAG_LO_HIGHLIGHT, GO_DYNFLAG_LO_NO_INTERACT, GO_DYNFLAG_LO_SPARKLE,
    GO_FLAG_IN_MULTI_USE, GO_FLAG_IN_USE, GO_FLAG_INTERACT_COND, GO_FLAG_NODESPAWN, GameObject,
...
pub use player::{
    ...
    ACTIVE_PLAYER_DATA_QUEST_COMPLETED_PARENT_BIT, ACTIVE_PLAYER_DATA_WATCHED_FACTION_INDEX_BIT,
    ...
    PLAYER_DATA_FLAGS_EX_BIT, PLAYER_DATA_HONOR_LEVEL_BIT, PLAYER_DATA_LOOT_TARGET_GUID_BIT,
    PLAYER_DATA_NATIVE_SEX_BIT, PLAYER_DATA_NUM_BANK_SLOTS_BIT, PLAYER_DATA_PARENT_BIT,
    PLAYER_DATA_VISIBLE_ITEMS_FIRST_BIT, PLAYER_DATA_VISIBLE_ITEMS_PARENT_BIT, PLAYER_SLOT_END,
    Player, PlayerAchievementCriteriaRecord, PlayerAchievementRecord, PlayerActionButtonRecord,
    PlayerBagStorage, PlayerBattlegroundQueueRecord, PlayerBattlegroundState,
    PlayerCreateLifecycleRecord, PlayerCurrencyRecord, PlayerDataUpdate, PlayerDataValues,
...
pub use unit::{
    ...
    SPELL_AURA_MOD_STALKED_LIKE_CPP, SPELL_AURA_MOD_UNATTACKABLE_LIKE_CPP, UNIT_DATA_ANIM_TIER_BIT,
    ...
    UNIT_DATA_NATIVE_DISPLAY_SCALE_BIT, UNIT_DATA_NPC_FLAGS_FIRST_BIT,
    UNIT_DATA_NPC_FLAGS_PARENT_BIT, UNIT_DATA_PARENT_BIT, UNIT_DATA_PET_FLAGS_BIT,
    UNIT_DATA_PLAYER_CLASS_ID_BIT, UNIT_DATA_POWER_FIRST_BIT, UNIT_DATA_POWER_PARENT_BIT,
    UNIT_DATA_PVP_FLAGS_BIT, UNIT_DATA_RACE_BIT, UNIT_DATA_SEX_BIT, UNIT_DATA_SHAPESHIFT_FORM_BIT,
    UNIT_DATA_SHEATHE_STATE_BIT, UNIT_DATA_STAND_STATE_BIT, UNIT_DATA_TARGET_BIT,
    UNIT_DATA_VIRTUAL_ITEMS_FIRST_BIT, UNIT_DATA_VIRTUAL_ITEMS_PARENT_BIT, UNIT_DATA_VIS_FLAGS_BIT,
    Unit, UnitAddToWorldOutcomeLikeCpp, UnitAttackContextLikeCpp, UnitAttackStartOutcome,
