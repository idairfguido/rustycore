...
pub use vehicle::{
    ...
    VehicleExitParameter, VehicleFlag, VehicleImmunityPlan, VehiclePassengerAddPlan,
    VehiclePassengerRemovePlan, VehiclePassengerTransportReset, VehiclePendingEventRemovalPlan,
    VehiclePendingJoinAbort, VehicleRemoveAllPassengersPlan, VehicleResetPlan, VehicleSeat,
